<h2><a href="https://www.geeksforgeeks.org/problems/number-of-occurrence2259/1?page=1&status=solved&sortBy=submissions">Number of Occurrence</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a&nbsp;sorted<strong>&nbsp;</strong>array <strong>arr[] </strong>and a number&nbsp;<strong>target</strong>, find the number of occurrences of&nbsp;target in given array.&nbsp;</span></p>
